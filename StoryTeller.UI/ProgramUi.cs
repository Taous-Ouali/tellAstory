...
namespace StoryTeller.UI
{
    public class ProgramUi
    {
        ...
        public ProgramUi()
        {
            ...
            speckledHen = _cRepo.GetCharacterByID(5);
        }
        public void Run()
        ...
        private void StartAdventure()
        {
            ...
            System.Console.WriteLine(@$"Adventure Started!
                                        ...
                                        A {speckledHen.Name} had made her nest in an out-of-the-way place to sit upon the eggs until they were hatched into chickens.
                                        The {speckledHen.Name} name each egg by the name it should be called when a chick.
            ...
            //System.Console.WriteLine("Here is the end of the adventure, thank you for playing.");
        }
